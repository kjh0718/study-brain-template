...
Study Brain의 `ingest-lecture` Skill이다. 규격은 한 곳에만 둔다.

**[`.agents/skills/ingest-lecture/SKILL.md`](../../../.agents/skills/ingest-lecture/SKILL.md)를 읽고 그대로 수행한다.**
이 파일은 Claude Code가 Skill을 찾기 위한 진입점이며 규칙을 따로 정의하지 않는다.
