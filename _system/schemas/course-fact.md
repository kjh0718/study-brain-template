...
권장 형태는 `FAC-<과목 slug>-<날짜>-<NN>`이다. 예: `FAC-general-physics-2-20260908-01`. 날짜는 그 사실이 확인된 날이다. 같은 날 여러 운영 사실이 나올 수 있으므로 일련번호를 쓰며, 번호는 (FAC, 과목, 날짜) 범위에서만 센다. supersede로 대체된 뒤에도 이전 FAC의 ID는 그대로 남는다.
